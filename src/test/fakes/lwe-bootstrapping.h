...
namespace {
    ...
    inline LweBootstrappingKey *fake_new_LweBootstrappingKey(int ks_t, int ks_basebit, const LweParams *in_out_params,
 ...
 */
    inline void fake_tfhe_blindRotate(TLweSample *accum, const TGswSample *bk, const int *bara, const int n,
                                      const TGswParams *bk_params) {
...
#define USE_FAKE_tfhe_bootstrap_woKS \
    static inline void tfhe_bootstrap_woKS(LweSample *result, const LweBootstrappingKey *bk, Torus32 mu, const LweSample *x, const int32_t window_size) {\
